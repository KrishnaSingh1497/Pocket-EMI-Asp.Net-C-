<%@ Page Title="" Language="C#" MasterPageFile="~/HTML/Management.master" AutoEventWireup="true" CodeFile="AgentBlog.aspx.cs" Inherits="HTML_AgentBlog" %>
     ...
     <div class="container-fluid">
        <div class="row">
            <div class="col-md-5">
                            ...
                            <div class="col-md-3">
                               <label>Blog ID</label>
                                 <div class="form-group">
                                     ...
                                     <asp:TextBox ID="txtblogid" class="form-control" placeholder="ID" runat="server"></asp:TextBox>
                         ...
                         <div class="row">
                            <div class="col-md-12">
                              <label>Blog Title</label>
                                <div class="form-group">
                                     <asp:TextBox ID="txtblogtitle" class="form-control" placeholder="Blog Title" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                              <label>Blog Description</label>
                                <div class="form-group">
                                     <asp:TextBox ID="txtblogdesc" class="form-control" placeholder="Blog Description" runat="server" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                ...
                <a href="AdminMember.aspx"><< Back to Home</a><br /><br />
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                    ...
                                    SelectCommand="SELECT * FROM [blog_master_tbl]"></asp:SqlDataSource>
                                    <hr />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:GridView ID="GridView1" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="blog_id" DataSourceID="SqlDataSource1">
                                    <Columns>
                                        <asp:BoundField DataField="blog_id" HeaderText="ID" ReadOnly="True" SortExpression="blog_id" >
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-lg-10">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("blog_title") %>' Font-Bold="True" Font-Size="X-Large"></asp:Label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    &nbsp;&nbsp; |&nbsp; Blog type:
                                                                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Text='<%# Eval("blog_type") %>'></asp:Label>
                                                                    &nbsp;&nbsp; |&nbsp; Published date:&nbsp;
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    Descriptions:&nbsp;&nbsp;
                                                                    <asp:Label ID="Label5" runat="server" Font-Bold="True" Text='<%# Eval("blog_description") %>'></asp:Label>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <asp:Image ID="Image1" class="img-fluid" runat="server" ImageUrl='<%# Eval("blog_img_link") %>' />
                                                        </div>
                                                    </div>
                                                </div>
                                            </ItemTemplate>
